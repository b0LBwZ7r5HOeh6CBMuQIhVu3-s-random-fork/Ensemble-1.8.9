...
import it.fktcod.ktykshrk.skinchanger.CacheRetriever;
import it.fktcod.ktykshrk.skinchanger.TextureReflection;
import it.fktcod.ktykshrk.skinchanger.resources.BetterJsonObject;
...
private static final HashMap<String, String> responses = new HashMap<>();
	...
	public static void addTexture(Type type, String content) {
		...
		if(loaded) { ChatUtils.message(
			...
			Module module = HackManager.getHack("SkinChanger"); 
