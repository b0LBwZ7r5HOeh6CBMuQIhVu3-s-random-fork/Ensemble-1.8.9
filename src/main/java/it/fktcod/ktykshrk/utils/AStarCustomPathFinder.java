...
public class AStarCustomPathFinder
{
    ...
    private static boolean isBlockSolid(BlockPos block)
    {
        ...
        return
               (Minecraft.getMinecraft().theWorld.getBlockState(block) instanceof BlockSlab) ||
               (Minecraft.getMinecraft().theWorld.getBlockState(block) instanceof BlockStairs) ||
               (Minecraft.getMinecraft().theWorld.getBlockState(block) instanceof BlockCactus) ||
               (Minecraft.getMinecraft().theWorld.getBlockState(block) instanceof BlockChest) ||
               (Minecraft.getMinecraft().theWorld.getBlockState(block) instanceof BlockEnderChest) ||
               (Minecraft.getMinecraft().theWorld.getBlockState(block) instanceof BlockSkull) ||
               (Minecraft.getMinecraft().theWorld.getBlockState(block) instanceof BlockPane) ||
               (Minecraft.getMinecraft().theWorld.getBlockState(block) instanceof BlockFence) ||
               (Minecraft.getMinecraft().theWorld.getBlockState(block) instanceof BlockWall) ||
               (Minecraft.getMinecraft().theWorld.getBlockState(block) instanceof BlockGlass) ||
               (Minecraft.getMinecraft().theWorld.getBlockState(block) instanceof BlockPistonBase) ||
               (Minecraft.getMinecraft().theWorld.getBlockState(block) instanceof BlockPistonExtension) ||
               (Minecraft.getMinecraft().theWorld.getBlockState(block) instanceof BlockPistonMoving) ||
               (Minecraft.getMinecraft().theWorld.getBlockState(block) instanceof BlockStainedGlass) ||
               (Minecraft.getMinecraft().theWorld.getBlockState(block)instanceof BlockTrapDoor);
    }
