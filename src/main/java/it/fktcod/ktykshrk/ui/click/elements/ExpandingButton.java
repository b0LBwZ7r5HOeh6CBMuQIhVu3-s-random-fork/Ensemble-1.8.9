...
import it.fktcod.ktykshrk.ui.click.base.Container;
import it.fktcod.ktykshrk.ui.click.listener.ComponentClickListener;
...
public class ExpandingButton extends Container {
    ...
    public ExpandingButton(int xPos, int yPos, int width, int buttonHeight, Component component, String text, Module module) {
        super(xPos, yPos, width, 0, ComponentType.EXPANDING_BUTTON, component, text);
        this.buttonHeight = buttonHeight;
        this.component = component;
        this.module = module;
