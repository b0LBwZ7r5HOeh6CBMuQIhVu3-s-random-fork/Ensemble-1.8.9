package it.fktcod.ktykshrk.ui.clickgui.ast;
...
import it.fktcod.ktykshrk.ui.clickgui.huangbai.gl.GLClientState;
import it.fktcod.ktykshrk.ui.clickgui.huangbai.tessellate.Tessellation;
...
public class RenderUtil
{
    ...
    public static void drawFilledCircle(float xx, float yy, float radius, Color col) {
        ...
        while (i < sections) {
            ...
            glColor4f((float) ((float) col.getRed() / 255.0f), (float) ((float) col.getGreen() / 255.0f),
    ...
    public static void drawFullCircle(int cx, int cy, double r, int segments, float lineWidth, int part, int c) {
        ...
        glEnable((int) 2848);
        GL11.glBlendFunc((int) 770, (int) 771);
        glColor4f((float) f22, (float) f3, (float) f4, (float) f2);
        glBegin((int) 3);
        int i = segments - part;
        while (i <= segments) {
