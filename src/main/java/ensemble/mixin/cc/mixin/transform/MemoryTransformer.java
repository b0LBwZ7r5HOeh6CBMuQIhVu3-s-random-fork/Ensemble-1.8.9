package ensemble.mixin.cc.mixin.transform;
        ...
        RemappingClassAdapter adapter = new RemappingClassAdapter(classWriter, new Remapper() {
            ...
            public String map(String typeName) {
                if (typeName.equals("CapeUtils$1")) {
                    return "it.fktcod.ktykshrk.utils.CapeImageBuffer".replace('.', '/');
                }
                return typeName;
            }
        });
            ...
            while (iter.hasNext()) {
                ...
                if (insn.getOpcode() == Opcodes.ARETURN) {
                    method.instructions.insertBefore(insn, new MethodInsnNode(
                            ...
                            "it.fktcod.ktykshrk.utils.ResourcePackImageScaler".replace('.', '/'),
                            "scalePackImage",
